...
public class RegistroVehiculosController {
    ...
    @FXML
    private ChoiceBox<?> es4x4Camioneta;

    @FXML
    private ChoiceBox<?> es4x4Pick;

    @FXML
    private ChoiceBox<?> estadoVehiculo;
    ...
    @FXML
    private ChoiceBox<?> tieneABSBus;

    @FXML
    private ChoiceBox<?> tieneABSCamion;

    @FXML
    private ChoiceBox<?> tieneABSw;

    @FXML
    private TextField tieneACCamion;

    @FXML
    private ChoiceBox<?> tieneACSw;

    @FXML
    private ChoiceBox<?> tieneAsistenteCarrilSedaneta;

    @FXML
    private ChoiceBox<?> tieneCamaraSw;

    @FXML
    private ChoiceBox<?> tieneFrenosCamion;

    @FXML
    private ChoiceBox<?> tieneSensorCruzadoSedaneta;

    @FXML
    private ChoiceBox<?> tieneSensoresColisionSedaneta;

    @FXML
    private ChoiceBox<?> tieneVelCruceroSedaneta;

    @FXML
    private ChoiceBox<?> tipoAutos;

    @FXML
    private TextField tipoCamion;

    @FXML
    private ChoiceBox<?> tipoCombustible;

    @FXML
    private ChoiceBox<?> tipoTransimicion;

    @FXML
    private ChoiceBox<?> tipoVehiculo;
